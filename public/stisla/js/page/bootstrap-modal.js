...
$("#modal-banner").fireModal({
    title: "Ganti Banner",
    body: $("#modal-edit-banner"),
});

$("#modal-superadmin-admin").fireModal({
    title: "Tambah Admin",
    body: $("#modal-tambah-admin"),
});

$("#modal-superadmin-tambah-kategori").fireModal({
    title: "Tambah Kategori",
    body: $("#modal-tambah-kategori"),
});

// Admin Kabupaten

$("#modal-admin-kabupaten-tambah").fireModal({
    title: "Tambah Admin",
    body: $("#modal-admin-kabupaten-tambah-admin"),
});
