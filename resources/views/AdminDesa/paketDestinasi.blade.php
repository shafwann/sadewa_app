            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin-desa/paket-destinasi') }}" class="nav-link bg-primary">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="detailPaketDesti">
                                                ...
                                                <div class="deskripsiPaketDesti">
                                                    <h3>{{ str_replace('|', ' + ', $pak['destinasi']) }}</h3>
                        ...
                        <div class="modal-dialog" style="max-width: 1000px">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('/admin-desa/tambah-paket') }}" method="POST"
                                            ...
                                            @foreach ($destinasi as $dest)
                                                <div>
                                                    <input type="checkbox" id="checkbox{{ $dest['id'] }}"
                                                        name="checkbox[]" value="{{ $dest['nama_destinasi'] }}"
