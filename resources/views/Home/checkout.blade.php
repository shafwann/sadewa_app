            ...
            @if (isset($destinasi))
                ...
                <script type="text/javascript">
                    ...
                    payButton.addEventListener('click', function() {
                        ...
                        window.snap.pay('{{ $snapTokenDestinasi }}', {
                            onSuccess: function(result) {
                                /* You may add your own implementation here */
                                // alert("payment success!");
                                window.location.href = "/invoice/destinasi/{{ $tiket['id'] }}";
                                console.log(result);
                            },
            ...
            @if (isset($paket))
                <div class="lanjutBayar">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <p class="col-sm-3">Jumlah Paket</p>
                            <p> : {{ $tiket['jumlah_tiket'] }}</p>
                        </div>
                        <div class="row">
                            <p class="col-sm-3">Total Harga</p>
                ...
                <script type="text/javascript">
                    ...
                    payButton.addEventListener('click', function() {
                        // Trigger snap popup. @TODO: Replace TRANSACTION_TOKEN_HERE with your transaction token
                        window.snap.pay('{{ $snapTokenPaket }}', {
                            onSuccess: function(result) {
                                /* You may add your own implementation here */
                                // alert("payment success!");
                                window.location.href = "/invoice/paket/{{ $tiket['id'] }}";
